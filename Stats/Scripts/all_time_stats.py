...
column_headers=['ID', 'LAST NAME', 'FIRST NAME', 'TKD', 'TKO', 'TKB', 'E121D', 'E122D', 'ENO', 'ENB', 'FMD', 'FMO', 'FMB', 'HMD', 'HMO', 'CTD', 'CTO', 'CTB', 'AMD', 'AMO', 'AMB', 'PAD', 'PAO', 'PAB', 'STAT', 'CFO','MON', 'YR', 'M RANK', 'Y RANK','MO %']
			...
			for unit in units_ls:
				for seat in seats_ls:
					...
					# 		stats_array.loc[member,'HMO'] = int(stats_array.loc[member,'HMO'] +1)
						...
						if 'Dr' in unit+seat:
							stats_array.loc[member,'E121D'] = int(stats_array.loc[member,'E121D'] +1)
						...
						if 'Dr' in unit+seat:
							stats_array.loc[member,'E122D'] = int(stats_array.loc[member,'E122D'] +1)
							eng_count = eng_count + 1
						elif 'Off' in unit+seat:
							stats_array.loc[member,'ENO'] = int(stats_array.loc[member,'ENO'] +1)
						else:
...
stats_array.to_csv(output_location+'all_time.csv')
# print(fire_mo)
print(ambo_count)
print(fire_count)
