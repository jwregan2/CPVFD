...
for year in year_ar:
	for past_mo in mo_ar:
		print(past_mo,year)
		# if year == 2018 and past_mo < 9:
		# 	continue
		print(past_mo)
		# if year == 201 and past_mo > 7:
		# 	continue
	...
	print('EMS '+ str(ambo_count))
	print('FF&EMS '+ str(fire_count+ambo_count))
...
stats_array=stats_array.sort_values(by=['WF'])
